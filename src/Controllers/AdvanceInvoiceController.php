...
class AdvanceInvoiceController extends BaseController
{
     ...
     */
    public function issueAdvanceInvoice(string $subscriptionId, ?IssueAdvanceInvoiceRequest $body = null): ?Invoice
    {
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function readAdvanceInvoice(string $subscriptionId): ?Invoice
    {
        $_reqBuilder = $this->requestBuilder(
            RequestMethod::GET,
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function voidAdvanceInvoice(string $subscriptionId, ?VoidInvoiceRequest $body = null): ?Invoice
    {
        $_reqBuilder = $this->requestBuilder(
            RequestMethod::POST,
