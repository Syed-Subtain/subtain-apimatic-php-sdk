...
class SubscriptionComponentsController extends BaseController
{
     ...
     *
     * @return AllocationResponse[]|null Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function allocateComponents(string $subscriptionId, ?AllocateComponents $body = null): ?array
    {
     ...
     *
     * @return UsageResponse|null Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
     ...
     *
     * @return SubscriptionComponentResponse|null Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function readSubscriptionComponent(string $subscriptionId, int $componentId): ?SubscriptionComponentResponse
    {
        $_reqBuilder = $this->requestBuilder(
            RequestMethod::GET,
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function resetSubscriptionComponentsPricePoints(string $subscriptionId): ?SubscriptionResponse
    {
        $_reqBuilder = $this->requestBuilder(
            RequestMethod::POST,
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function listAllocations(string $subscriptionId, int $componentId, ?int $page = 1): ?array
    {
        $_reqBuilder = $this->requestBuilder(
            RequestMethod::GET,
     ...
     *
     * @return AllocationPreviewResponse|null Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
     ...
     *
     * @return BulkComponentSPricePointAssignment|null Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
     ...
     * @param array $options Array with all options for search
     *
     * @return ListSubscriptionComponentsResponse|null Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/subscriptions_components.json')
            ...
            ->parameters(
                ...
                QueryParam::init('filter[subscription][states]', $options)
                    ...
                    ->serializeBy([SubscriptionState::class, 'checkValue']),
