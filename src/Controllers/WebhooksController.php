...
class WebhooksController extends BaseController
{
     ...
     *
     * @return WebhookResponse[]|null Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
     ...
     *
     * @return EnableWebhooksResponse|null Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
     ...
     *
     * @return EndpointResponse|null Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
