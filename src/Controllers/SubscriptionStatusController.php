...
class SubscriptionStatusController extends BaseController
{
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function cancelDunning(string $subscriptionId): ?SubscriptionResponse
    {
        $_reqBuilder = $this->requestBuilder(
            RequestMethod::POST,
     ...
     *
     * @return RenewalPreviewResponse|null Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function previewRenewal(
        string $subscriptionId,
        ?RenewalPreviewRequest $body = null
