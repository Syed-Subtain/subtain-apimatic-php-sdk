...
class InvoicesController extends BaseController
{
     ...
     *
     * @return ListCreditNotesResponse|null Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
     ...
     *
     * @return CreditNote|null Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
     ...
     *
     * @return PaymentResponse|null Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
     ...
     * @param array $options Array with all options for search
     *
     * @return ConsolidatedInvoice|null Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
     ...
     *
     * @return MultiInvoicePaymentResponse|null Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
     ...
     * @param array $options Array with all options for search
     *
     * @return ListInvoicesResponse|null Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
     ...
     * @param array $options Array with all options for search
     *
     * @return ListInvoiceEventsResponse|null Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
     ...
     *
     * @return InvoiceResponse|null Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function createInvoice(string $subscriptionId, ?CreateInvoiceRequest $body = null): ?InvoiceResponse
    {
     ...
     *        facing invoice number.
     *
     * @return CustomerChangesPreviewResponse|null Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
