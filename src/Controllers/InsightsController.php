...
class InsightsController extends BaseController
{
     ...
     * ```
     *
     * @return SiteSummary|null Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
     ...
     *
     * @return ListMRRResponse|null Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
     ...
     * @param array $options Array with all options for search
     *
     * @return SubscriptionMRRResponse|null Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
