...
class SalesCommissionsController extends BaseController
{
     ...
     *
     * @return ListSaleRepItem[]|null Response from the API call
     *
     ...
     *
     * @return SaleRep|null Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
     ...
     * @param array $options Array with all options for search
     *
     * @return SaleRepSettings[]|null Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
