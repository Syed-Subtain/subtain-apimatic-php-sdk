...
```php
function deleteSubscriptionsPaymentProfile(string $subscriptionId, string $paymentProfileId): void
```
...
```php
function sendRequestUpdatePaymentEmail(string $subscriptionId): void
```
